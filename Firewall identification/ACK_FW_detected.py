...
elif ((ACK_response == None) or (SYN_response == None)) and not ((ACK_response ==None) and (SYN_response == None)): #En caso de que uno y solo uno de los  paquetes enviados haya recibido respuesta
